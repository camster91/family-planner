...
- Stored in `e2e/__screenshots__/<spec>/<name>-<project>-linux.png`: 20 images (login + dashboard light + dashboard dark, × 6 viewports; plus the fridge-mode Today board at 1280×800 and 800×1280, full page).
