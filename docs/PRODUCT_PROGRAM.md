...
| 2026-09-01 | Recommend Resend Free for the five-household beta | Purpose-built delivery evidence, domain-scoped sending credentials, and free beta capacity are a better fit than the generic Maton Gmail proxy | Owner approves account, DNS, sender, secret, and review test inbox, or new evidence changes the provider choice |

## Risk and blocker register

| Risk                                                  | Owner         | Mitigation / unblock condition                                                                            |
| ----------------------------------------------------- | ------------- | --------------------------------------------------------------------------------------------------------- |
| Transactional email recommendation awaits approval    | Release owner | Approve the Resend beta package, verified sender, review secret, and test inbox; then prove live delivery |
...
| 2026-09-01 | Moved every workflow to Ashbi and promoted exact PR #101 head `c730cfa` to review           | Runs `33527793043` and `33527793162`; release gate, beta scorecard smoke, APK, exact image build, backup, live core loop, rollback retention, and review inspection passed                                                                | Require an explicit verified email sender, then prove approved review delivery using `TRANSACTIONAL_EMAIL_RUNBOOK.md`     |
| 2026-09-01 | Prepared the transactional-email provider decision and exact approval package               | Current official provider pricing, domain-authentication, credential-scope, and delivery-event documentation compared; Resend Free recommended without changing DNS, secrets, or sending email                                            | Obtain exact approval for the proposed account, sending subdomain, sender, review secret, and owner-controlled test inbox |
